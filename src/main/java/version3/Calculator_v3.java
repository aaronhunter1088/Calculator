...
public abstract class Calculator_v3 extends JFrame {
    ...
    final protected String[] values = {"","",""}; // firstNum (total), secondNum, copy/paste. memory values now in MemorySuite.getMemoryValues()
 		...
 		public void actionPerformed(ActionEvent e) {   
 	        ...
 	        if (firstNumBool == true) {
 	            ...
 	            if (dotButtonPressed == false && !textArea.getText().endsWith("-")) {        
 	                ...
 	                LOGGER.info("textarea: '" + textarea + "'");
 	                values[position] = textarea; // store textarea
 	                ...
 	                if (!textarea.equals("") && dotButtonPressed) {
 	                	textarea = values[position] + "." + e.getActionCommand();
 	                	textArea.setText("\n" + textarea );
 	                	LOGGER.info("textarea: " + textarea);
 	                	values[position] = textArea.getText().replaceAll("\n", "");
 	                	dotButtonPressed = false;
 	                    ...
 	                    values[position] =  textArea.getText(); // store textarea
 	                    textArea.setText("\n" + textArea.getText());
 	                    LOGGER.info("textArea: '\\n" + textArea.getText().replaceAll("\n", "") + "'");
 	                    LOGGER.info("temp["+position+"]: '" + values[position] + "'");
 	                    ...
 	                    textarea = "";
 	                    LOGGER.info("dotButtonPressed: '", dotButtonPressed + "'");
 	                    LOGGER.info("temp["+position+"]: '" + values[position] + "'"); // print out stored textarea confirmation
 	                    dotButtonPressed = false;
 	                    LOGGER.info("dotButtonPressed: '", dotButtonPressed + "'");
 	                } else if (values[position].endsWith("-.0")) {
 	                    textarea = values[position];
 	                    LOGGER.info("textarea: '", textarea + "'");
 	                ...
 	                } else if (values[position].startsWith("-0.")){
 	            ...
 	            if (firstNumBool == false && negatePressed == false) {
 	            	...
 	            	LOGGER.info("textArea: '" + textArea.getText() + "'");
 	            	values[position] = convertToNegative(e.getActionCommand());
 	            	negatePressed = false;
