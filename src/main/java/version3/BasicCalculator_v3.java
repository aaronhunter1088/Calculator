...
//        constraints.fill = GridBagConstraints.HORIZONTAL;
//        addComponent(buttonDelete, 3, 0, 1, 1);
//        buttonDelete.addActionListener(delButtonHandler);
//        constraints.fill = GridBagConstraints.HORIZONTAL;
//        addComponent(buttonClearEntry, 3, 1, 1, 1);
//        buttonClearEntry.addActionListener(CEButtonHandler);
//        constraints.fill = GridBagConstraints.HORIZONTAL;
//        addComponent(buttonClear, 3, 2, 1, 1);
