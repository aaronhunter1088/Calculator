...
Version Three Concluded: February 6, 2021
            ...
            | Scientific - Added functions such as trigonometric functions

            | Programmer - Added functions such as algebraic functions

            | Date Calculation - Difference between dates, and Dates addition/subtraction

            | Converter (has more subclasses; may be on top tier of its own)
