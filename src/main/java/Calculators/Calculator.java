...
//    public static final Font font = new Font("Segoe UI", Font.PLAIN, 12), // all panels
//                             font2 = new Font("Verdana", Font.BOLD, 20), // Converter, Date panels
//                             font_Bold = new Font("Segoe UI", Font.BOLD, 12); // Date panel
...
//    {
//        textArea = new JTextArea(2,5); // rows, columns
...
//            throw new CalculatorError("CalculatorType cannot be null");
//        }
//        if (calcType == BASIC)
//        {
