...
import calculator.entities.DateOperation;
...
import static calculator.entities.Calculator.*;
import static calculator.entities.CalculatorView.VIEW_DATE;
import static calculator.entities.DateOperation.ADD_SUBTRACT_DAYS;
import static calculator.entities.DateOperation.DIFFERENCE_BETWEEN_DATES;
import static calculator.entities.Texts.*;
import static calculator.utilities.LoggingUtility.confirm;
import static calculator.utilities.LoggingUtility.logActionButton;
...
public class DatePanel extends JPanel
{
    ...
    {
        if (dateOperationsDropdown.getSelectedItem() == DIFFERENCE_BETWEEN_DATES) { // Only Switch to OPTIONS1 if and only if we are really showing OPTIONS2
            calculator.setDateOperation(DateOperation.DIFFERENCE_BETWEEN_DATES);
            switchComponentsForDateDifference();
            setupHelpMenu();
            updateThisPanel();
            confirm(calculator, LOGGER, "Changing to " + DIFFERENCE_BETWEEN_DATES);
        } else if (dateOperationsDropdown.getSelectedItem() == ADD_SUBTRACT_DAYS) { // Only Switch to OPTIONS2 if and only if we are really showing OPTIONS1
    ...
    public int[] calculateDifferenceBetweenDates()
    {
        ...
        if (fromDate.isBefore(toDate)) {
            ...
            days = period.getDays();
            while (days / 7 > 0) { // if there's 7 days, add 1 to weeks, subtract 7 from days
                weeks += 1;
                days -= 7;
            }
    ...
    public UtilCalendarModel getFromCalendar()
    {
        return fromCalendar;
    }

    public void setFromCalendar(UtilCalendarModel fromCalendar)
    {
        this.fromCalendar = fromCalendar;
        LOGGER.debug("From Calendar set");
    }

    public UtilCalendarModel getToCalendar()
    {
        return toCalendar;
    }

    public void setToCalendar(UtilCalendarModel toCalendar)
    {
        this.toCalendar = toCalendar;
        LOGGER.debug("To Calendar set");
    }
    ...
    public void setFromDatePanel(JDatePanelImpl fromDatePanel)
    {
        this.fromDatePanel = fromDatePanel;
        LOGGER.debug("From DatePanel set");
    }
    ...
    public void setToDatePanel(JDatePanelImpl toDatePanel)
    {
        this.toDatePanel = toDatePanel;
        LOGGER.debug("To DatePanel set");
    }
    ...
    public void setFromDatePicker(JDatePickerImpl fromDatePicker)
    {
        this.fromDatePicker = fromDatePicker;
        LOGGER.debug("From DatePicker set");
    }
    ...
    public void setToDatePicker(JDatePickerImpl toDatePicker)
    {
        this.toDatePicker = toDatePicker;
        LOGGER.debug("To DatePicker set");
    }
    ...
    public JComboBox<DateOperation> getDateOperationsDropdown()
    {
        return dateOperationsDropdown;
    }

    private void setDateOperationsDropdown(JComboBox<DateOperation> dateOperationsDropdown)
    {
        this.dateOperationsDropdown = dateOperationsDropdown;
        LOGGER.debug("DateOperations Dropdown set");
    }
    ...
    private void setFromDateLabel(JLabel fromDateLabel)
    {
        ...
        LOGGER.debug("From Date Label set");
    }
    ...
    private void setToDateLabel(JLabel toDateLabel)
    {
        ...
        LOGGER.debug("To Date Label set");
    }
    ...
    private void setDifferenceLabel(JLabel differenceLabel)
    {
        ...
        LOGGER.debug("Difference Label set");
    }
    ...
    private void setMonthLabel(JLabel monthLabel)
    {
        ...
        LOGGER.debug("Month Label set");
    }

    public JLabel getWeeksLabel()
    {
        return weeksLabel;
    }

    private void setWeeksLabel(JLabel weeksLabel)
    {
        this.weeksLabel = weeksLabel;
        LOGGER.debug("Weeks Label set");
    }
    ...
    private void setResultsLabel(JLabel resultsLabel)
    {
        ...
        LOGGER.debug("Results Label set");
    }

    public JLabel getYearsDifferenceLabel()
    {
        return yearsDifferenceLabel;
    }

    private void setYearsDifferenceLabel(JLabel yearsDifferenceLabel)
    {
        this.yearsDifferenceLabel = yearsDifferenceLabel;
        LOGGER.debug("Years Difference Label set");
    }

    public JLabel getMonthsDifferenceLabel()
    {
        return monthsDifferenceLabel;
    }

    private void setMonthsDifferenceLabel(JLabel monthsDifferenceLabel)
    {
        this.monthsDifferenceLabel = monthsDifferenceLabel;
        LOGGER.debug("Months Difference Label set");
    }

    public JLabel getWeeksDifferenceLabel()
    {
        return weeksDifferenceLabel;
    }

    private void setWeeksDifferenceLabel(JLabel weeksDifferenceLabel)
    {
        this.weeksDifferenceLabel = weeksDifferenceLabel;
        LOGGER.debug("Weeks Difference Label set");
    }

    public JLabel getDaysDifferenceLabel()
    {
        return daysDifferenceLabel;
    }

    private void setDaysDifferenceLabel(JLabel daysDifferenceLabel)
    {
        this.daysDifferenceLabel = daysDifferenceLabel;
        LOGGER.debug("Days Difference Label set");
    }
    ...
    private void setButtonGroupPanel(JPanel buttonGroupPanel)
    {
        ...
        LOGGER.debug("Button Group Panel set");
    }
    ...
    private void setTextFieldsGroupPanel(JPanel textFieldsGroupPanel)
    {
        ...
        LOGGER.debug("Text Fields Group Panel set");
    }
    ...
    private void setAddRadioButton(JRadioButton addRadioButton)
    {
        ...
        LOGGER.debug("Add RadioButton set");
    }
    ...
    private void setSubtractRadioButton(JRadioButton subtractRadioButton)
    {
        ...
        LOGGER.debug("Subtract RadioButton set");
    }
    ...
    private void setYearsTextField(JTextField yearsTextField)
    {
        ...
        LOGGER.debug("Years TextField set");
    }
    ...
    private void setMonthsTextField(JTextField monthsTextField)
    {
        ...
        LOGGER.debug("Months TextField set");
    }

    public JTextField getWeeksTextField()
    {
        return weeksTextField;
    }

    private void setWeeksTextField(JTextField weeksTextField)
    {
        this.weeksTextField = weeksTextField;
        LOGGER.debug("Weeks TextField set");
    }
    ...
    private void setDaysTextField(JTextField daysTextField)
    {
        ...
        LOGGER.debug("Days TextField set");
    }
