...
public class JPanelProgrammerMethodsTest
{
    ...
    public void pressingNotButtonReversesAllBits() {
        ...
        calculator.textArea.setText("00001011");
        programmerPanel.performButtonNotActions(actionEvent);
        //assertEquals("topQWord not as expected", ""); // lots of 1's
        assertEquals("textarea not as expected", expected, calculator.textArea.getText().replaceAll("\n", ""));
    }
    ...
    public void testProgrammerNumberEntry() throws CalculatorError_v4 {
        ...
        assertTrue("Values[0] should not match "+ calculator.textArea, !(String.valueOf(calculator.values[0]).equals(calculator.getTextAreaWithoutNewLineCharactersOrWhiteSpace())));
        assertEquals("plus operator not appended", "\n + 00000101", calculator.textArea.getText());
    ...
    public void testPushingButtonOrWithBothValuesSetReturnsCorrectResult() throws CalculatorError_v4 {
        ...
        calculator.textArea.setText(calculator.addNewLineCharacters(1)+ calculator.values[1]);
    ...
    public void testPushingModulusButtonWithOneInputReturnsZero() {
        ...
        calculator.textArea.setText(calculator.addNewLineCharacters(1)+number);
        calculator.updateTextareaFromTextArea();
        calculator.values[0] = "5";
        calculator.values[1] = "";
        calculator.valuesPosition = 0;
